...
$path ="C:/wamp64/www/CourseManagementSystem/PU-Note/View/static/Faculty/$row->faculty_name/$row->program_name/Syllabus/Semester/$semester/"; 
...
if (isset($_POST['sortclick']))
{
    if($_POST['sortclick']=='yes')
    {
        ...
        $sql="SELECT * FROM `syllabus` WHERE program='$req_program' AND semester='$req_semester'";
        $result=$conn->query($sql);
...

{
    ...
    if (isset($_FILES['updated_file']))
    {
            ...
            $file=explode(".",$filename)[0];
            $path ="C:/wamp64/www/CourseManagementSystem/PU-Note/View/static/Faculty/$row->faculty_name/$row->program_name/Syllabus/Semester/$updated_semester/";    
            $updated_filepath=$path.$filename;
        if (is_uploaded_file($_FILES['updated_file']['tmp_name'])) 
                {
                    echo "file upload vako ho"."<br>";
            ...
            {
                $curr_path ="C:/wamp64/www/CourseManagementSystem/PU-Note/View/static/Faculty/$row->faculty_name/$row->program_name/Syllabus/Semester/$updated_semester/$prev_filename"; 
